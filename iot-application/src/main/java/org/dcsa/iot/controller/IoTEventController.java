package org.dcsa.iot.controller;

import jakarta.servlet.http.HttpServletRequest;
import jakarta.servlet.http.HttpServletResponse;
import jakarta.validation.constraints.Min;
import lombok.RequiredArgsConstructor;
import org.dcsa.iot.domain.persistence.entity.EventCache_;
...
public class IoTEventController {
  ...
  public IoTEventTO findEvent(@PathVariable("eventID") UUID eventID) {
    return ioTEventService.findEvent(eventID);
  }

  @GetMapping(path = "/events")
  @ResponseStatus(HttpStatus.OK)
  public List<IoTEventTO> findEvents(
    ...
    return Pagination
      ...
      .paginate(pageRequest ->
        ioTEventService.findEvents(pageRequest, EventCacheFilters.builder()
